...
from ...models.put_api_organizations_id_users_user_id_roles_body import PutApiOrganizationsIdUsersUserIdRolesBody
...
def _get_kwargs(
    ...
    user_id: str,
    *,
    body: PutApiOrganizationsIdUsersUserIdRolesBody,
) -> Dict[str, Any]:
