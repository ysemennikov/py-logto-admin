...
T = TypeVar("T", bound="PatchApiSignInExpBodyBranding")


@_attrs_define
class PatchApiSignInExpBodyBranding:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_sign_in_exp_body_branding = cls(
            logo_url=logo_url,
            dark_logo_url=dark_logo_url,
            favicon=favicon,
        )

        patch_api_sign_in_exp_body_branding.additional_properties = d
        return patch_api_sign_in_exp_body_branding
