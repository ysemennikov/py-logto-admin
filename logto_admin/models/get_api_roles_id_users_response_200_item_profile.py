...
if TYPE_CHECKING:
    from ..models.get_api_roles_id_users_response_200_item_profile_address import (
        GetApiRolesIdUsersResponse200ItemProfileAddress,
    )


T = TypeVar("T", bound="GetApiRolesIdUsersResponse200ItemProfile")


@_attrs_define
class GetApiRolesIdUsersResponse200ItemProfile:
    """
    Attributes:
        ...
        address (Union[Unset, GetApiRolesIdUsersResponse200ItemProfileAddress]):
    """
    ...
    address: Union[Unset, "GetApiRolesIdUsersResponse200ItemProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = GetApiRolesIdUsersResponse200ItemProfileAddress.from_dict(_address)

        get_api_roles_id_users_response_200_item_profile = cls(
        ...
        get_api_roles_id_users_response_200_item_profile.additional_properties = d
        return get_api_roles_id_users_response_200_item_profile
