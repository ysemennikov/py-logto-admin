...
if TYPE_CHECKING:
    from ..models.get_api_users_response_200_item_custom_data import GetApiUsersResponse200ItemCustomData
    from ..models.get_api_users_response_200_item_identities import GetApiUsersResponse200ItemIdentities
    from ..models.get_api_users_response_200_item_profile import GetApiUsersResponse200ItemProfile
    from ..models.get_api_users_response_200_item_sso_identities_item import GetApiUsersResponse200ItemSsoIdentitiesItem


T = TypeVar("T", bound="GetApiUsersResponse200Item")


@_attrs_define
class GetApiUsersResponse200Item:
    """
    Attributes:
        id (str):
        ...
        custom_data (GetApiUsersResponse200ItemCustomData): arbitrary
        identities (GetApiUsersResponse200ItemIdentities):
        last_sign_in_at (Union[None, float]):
        created_at (float):
        updated_at (float):
        profile (GetApiUsersResponse200ItemProfile):
        application_id (Union[None, str]):
        is_suspended (bool):
        has_password (Union[Unset, bool]):
        sso_identities (Union[Unset, List['GetApiUsersResponse200ItemSsoIdentitiesItem']]):
    """
    ...
    name: Union[None, str]
    avatar: Union[None, str]
    custom_data: "GetApiUsersResponse200ItemCustomData"
    identities: "GetApiUsersResponse200ItemIdentities"
    last_sign_in_at: Union[None, float]
    created_at: float
    updated_at: float
    ...
    sso_identities: Union[Unset, List["GetApiUsersResponse200ItemSsoIdentitiesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.get_api_users_response_200_item_identities import GetApiUsersResponse200ItemIdentities
        from ..models.get_api_users_response_200_item_profile import GetApiUsersResponse200ItemProfile
        from ..models.get_api_users_response_200_item_sso_identities_item import (
        ...
        custom_data = GetApiUsersResponse200ItemCustomData.from_dict(d.pop("customData"))

        identities = GetApiUsersResponse200ItemIdentities.from_dict(d.pop("identities"))
        ...
        profile = GetApiUsersResponse200ItemProfile.from_dict(d.pop("profile"))
        ...
        for sso_identities_item_data in _sso_identities or []:
            sso_identities_item = GetApiUsersResponse200ItemSsoIdentitiesItem.from_dict(sso_identities_item_data)

            sso_identities.append(sso_identities_item)

        get_api_users_response_200_item = cls(
            id=id,
            username=username,
        ...
        get_api_users_response_200_item.additional_properties = d
        return get_api_users_response_200_item
