...
T = TypeVar("T", bound="PutApiConfigsJwtCustomizerTokenTypePathBody")


@_attrs_define
class PutApiConfigsJwtCustomizerTokenTypePathBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_api_configs_jwt_customizer_token_type_path_body = cls(
            script=script,
        ...
        put_api_configs_jwt_customizer_token_type_path_body.additional_properties = d
        return put_api_configs_jwt_customizer_token_type_path_body
