...
T = TypeVar("T", bound="PostApiApplicationsBodyCustomClientMetadata")


@_attrs_define
class PostApiApplicationsBodyCustomClientMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_api_applications_body_custom_client_metadata = cls(
        ...
        post_api_applications_body_custom_client_metadata.additional_properties = d
        return post_api_applications_body_custom_client_metadata
