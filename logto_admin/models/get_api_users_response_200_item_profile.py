...
if TYPE_CHECKING:
    from ..models.get_api_users_response_200_item_profile_address import GetApiUsersResponse200ItemProfileAddress


T = TypeVar("T", bound="GetApiUsersResponse200ItemProfile")


@_attrs_define
class GetApiUsersResponse200ItemProfile:
    """
    Attributes:
        ...
        address (Union[Unset, GetApiUsersResponse200ItemProfileAddress]):
    """
    ...
    address: Union[Unset, "GetApiUsersResponse200ItemProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = GetApiUsersResponse200ItemProfileAddress.from_dict(_address)

        get_api_users_response_200_item_profile = cls(
        ...
        get_api_users_response_200_item_profile.additional_properties = d
        return get_api_users_response_200_item_profile
