...
if TYPE_CHECKING:
    from ..models.patch_api_users_user_id_response_200_custom_data import PatchApiUsersUserIdResponse200CustomData
    from ..models.patch_api_users_user_id_response_200_identities import PatchApiUsersUserIdResponse200Identities
    from ..models.patch_api_users_user_id_response_200_profile import PatchApiUsersUserIdResponse200Profile
    from ..models.patch_api_users_user_id_response_200_sso_identities_item import (
        PatchApiUsersUserIdResponse200SsoIdentitiesItem,
    )


T = TypeVar("T", bound="PatchApiUsersUserIdResponse200")


@_attrs_define
class PatchApiUsersUserIdResponse200:
    """
    Attributes:
        id (str):
        ...
        custom_data (PatchApiUsersUserIdResponse200CustomData): arbitrary
        identities (PatchApiUsersUserIdResponse200Identities):
        last_sign_in_at (Union[None, float]):
        created_at (float):
        updated_at (float):
        profile (PatchApiUsersUserIdResponse200Profile):
        application_id (Union[None, str]):
        is_suspended (bool):
        has_password (Union[Unset, bool]):
        sso_identities (Union[Unset, List['PatchApiUsersUserIdResponse200SsoIdentitiesItem']]):
    """
    ...
    name: Union[None, str]
    avatar: Union[None, str]
    custom_data: "PatchApiUsersUserIdResponse200CustomData"
    identities: "PatchApiUsersUserIdResponse200Identities"
    last_sign_in_at: Union[None, float]
    created_at: float
    updated_at: float
    ...
    sso_identities: Union[Unset, List["PatchApiUsersUserIdResponse200SsoIdentitiesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_data = PatchApiUsersUserIdResponse200CustomData.from_dict(d.pop("customData"))

        identities = PatchApiUsersUserIdResponse200Identities.from_dict(d.pop("identities"))
        ...
        profile = PatchApiUsersUserIdResponse200Profile.from_dict(d.pop("profile"))
        ...
        for sso_identities_item_data in _sso_identities or []:
            sso_identities_item = PatchApiUsersUserIdResponse200SsoIdentitiesItem.from_dict(sso_identities_item_data)

            sso_identities.append(sso_identities_item)

        patch_api_users_user_id_response_200 = cls(
            id=id,
            username=username,
        ...
        patch_api_users_user_id_response_200.additional_properties = d
        return patch_api_users_user_id_response_200
