...
T = TypeVar("T", bound="PatchApiConfigsAdminConsoleBodyCheckedChargeNotification")


@_attrs_define
class PatchApiConfigsAdminConsoleBodyCheckedChargeNotification:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_configs_admin_console_body_checked_charge_notification = cls(
            token=token,
        ...
        patch_api_configs_admin_console_body_checked_charge_notification.additional_properties = d
        return patch_api_configs_admin_console_body_checked_charge_notification
