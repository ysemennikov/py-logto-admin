...
if TYPE_CHECKING:
    from ..models.get_api_configs_jwt_customizer_response_200_item_type_0_value_context_sample_user_profile_address import (
        GetApiConfigsJwtCustomizerResponse200ItemType0ValueContextSampleUserProfileAddress,
    )


T = TypeVar("T", bound="GetApiConfigsJwtCustomizerResponse200ItemType0ValueContextSampleUserProfile")


@_attrs_define
class GetApiConfigsJwtCustomizerResponse200ItemType0ValueContextSampleUserProfile:
    """
    Attributes:
        ...
        address (Union[Unset, GetApiConfigsJwtCustomizerResponse200ItemType0ValueContextSampleUserProfileAddress]):
    """
    ...
    address: Union[Unset, "GetApiConfigsJwtCustomizerResponse200ItemType0ValueContextSampleUserProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = GetApiConfigsJwtCustomizerResponse200ItemType0ValueContextSampleUserProfileAddress.from_dict(
                _address
            )

        get_api_configs_jwt_customizer_response_200_item_type_0_value_context_sample_user_profile = cls(
        ...
        get_api_configs_jwt_customizer_response_200_item_type_0_value_context_sample_user_profile.additional_properties = d
        return get_api_configs_jwt_customizer_response_200_item_type_0_value_context_sample_user_profile
