...
from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_mfa_verification_factors_item import (
    GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserMfaVerificationFactorsItem,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_custom_data import (
        GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserCustomData,
    )
    from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_identities import (
        GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserIdentities,
    )
    from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_organization_roles_item import (
        GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserOrganizationRolesItem,
    )
    from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_organizations_item import (
        GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserOrganizationsItem,
    )
    from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile import (
        GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile,
    )
    from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_roles_item import (
        GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserRolesItem,
    )
    from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_sso_identities_item import (
        GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserSsoIdentitiesItem,
    )


T = TypeVar("T", bound="GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUser")


@_attrs_define
class GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUser:
    """
    Attributes:
        id (Union[Unset, str]):
        ...
        custom_data (Union[Unset, GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserCustomData]):
            arbitrary
        identities (Union[Unset, GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserIdentities]):
        last_sign_in_at (Union[None, Unset, float]):
        created_at (Union[Unset, float]):
        updated_at (Union[Unset, float]):
        profile (Union[Unset, GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile]):
        application_id (Union[None, Unset, str]):
        is_suspended (Union[Unset, bool]):
        sso_identities (Union[Unset,
            List['GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserSsoIdentitiesItem']]):
        mfa_verification_factors (Union[Unset,
            List[GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserMfaVerificationFactorsItem]]):
        roles (Union[Unset, List['GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserRolesItem']]):
        organizations (Union[Unset,
            List['GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserOrganizationsItem']]):
        organization_roles (Union[Unset,
            List['GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserOrganizationRolesItem']]):
    """
    ...
    profile: Union[Unset, "GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile"] = UNSET
    application_id: Union[None, Unset, str] = UNSET
    is_suspended: Union[Unset, bool] = UNSET
    sso_identities: Union[
        Unset, List["GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserSsoIdentitiesItem"]
    ] = UNSET
    mfa_verification_factors: Union[
        Unset, List[GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserMfaVerificationFactorsItem]
    ] = UNSET
    roles: Union[Unset, List["GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserRolesItem"]] = (
        UNSET
    )
    organizations: Union[
        Unset, List["GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserOrganizationsItem"]
    ] = UNSET
    organization_roles: Union[
        Unset, List["GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserOrganizationRolesItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_custom_data, Unset):
            ...
            custom_data = GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserCustomData.from_dict(
                _custom_data
            )
        ...
        if isinstance(_identities, Unset):
            ...
            identities = GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserIdentities.from_dict(
                _identities
            )
        ...
        if isinstance(_profile, Unset):
            ...
            profile = GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile.from_dict(
                _profile
            )
        ...
        for sso_identities_item_data in _sso_identities or []:
            sso_identities_item = (
                GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserSsoIdentitiesItem.from_dict(
        ...
        for roles_item_data in _roles or []:
            roles_item = GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserRolesItem.from_dict(
                roles_item_data
            )
        ...
        for organizations_item_data in _organizations or []:
            organizations_item = (
                GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserOrganizationsItem.from_dict(
        ...
        for organization_roles_item_data in _organization_roles or []:
            organization_roles_item = (
                GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserOrganizationRolesItem.from_dict(
        ...
        get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user = cls(
            id=id,
            username=username,
        ...
        get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user.additional_properties = d
        return get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user
