...
T = TypeVar("T", bound="PostApiConfigsJwtCustomizerTestBodyType0ContextUserProfileAddress")


@_attrs_define
class PostApiConfigsJwtCustomizerTestBodyType0ContextUserProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_api_configs_jwt_customizer_test_body_type_0_context_user_profile_address = cls(
            formatted=formatted,
        ...
        post_api_configs_jwt_customizer_test_body_type_0_context_user_profile_address.additional_properties = d
        return post_api_configs_jwt_customizer_test_body_type_0_context_user_profile_address
