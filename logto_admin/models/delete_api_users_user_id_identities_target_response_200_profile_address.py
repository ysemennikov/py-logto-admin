...
T = TypeVar("T", bound="DeleteApiUsersUserIdIdentitiesTargetResponse200ProfileAddress")


@_attrs_define
class DeleteApiUsersUserIdIdentitiesTargetResponse200ProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_api_users_user_id_identities_target_response_200_profile_address = cls(
            formatted=formatted,
        ...
        delete_api_users_user_id_identities_target_response_200_profile_address.additional_properties = d
        return delete_api_users_user_id_identities_target_response_200_profile_address
