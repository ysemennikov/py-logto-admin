...
if TYPE_CHECKING:
    from ..models.post_api_configs_jwt_customizer_test_body_type_0_context_user_profile_address import (
        PostApiConfigsJwtCustomizerTestBodyType0ContextUserProfileAddress,
    )


T = TypeVar("T", bound="PostApiConfigsJwtCustomizerTestBodyType0ContextUserProfile")


@_attrs_define
class PostApiConfigsJwtCustomizerTestBodyType0ContextUserProfile:
    """
    Attributes:
        ...
        address (Union[Unset, PostApiConfigsJwtCustomizerTestBodyType0ContextUserProfileAddress]):
    """
    ...
    address: Union[Unset, "PostApiConfigsJwtCustomizerTestBodyType0ContextUserProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = PostApiConfigsJwtCustomizerTestBodyType0ContextUserProfileAddress.from_dict(_address)

        post_api_configs_jwt_customizer_test_body_type_0_context_user_profile = cls(
        ...
        post_api_configs_jwt_customizer_test_body_type_0_context_user_profile.additional_properties = d
        return post_api_configs_jwt_customizer_test_body_type_0_context_user_profile
