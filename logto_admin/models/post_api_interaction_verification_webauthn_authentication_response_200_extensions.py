...
T = TypeVar("T", bound="PostApiInteractionVerificationWebauthnAuthenticationResponse200Extensions")


@_attrs_define
class PostApiInteractionVerificationWebauthnAuthenticationResponse200Extensions:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_api_interaction_verification_webauthn_authentication_response_200_extensions = cls(
            appid=appid,
            cred_props=cred_props,
            hmac_create_secret=hmac_create_secret,
        )

        post_api_interaction_verification_webauthn_authentication_response_200_extensions.additional_properties = d
        return post_api_interaction_verification_webauthn_authentication_response_200_extensions
