...
T = TypeVar("T", bound="PatchApiSignInExpResponse200PasswordPolicyRejects")


@_attrs_define
class PatchApiSignInExpResponse200PasswordPolicyRejects:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_sign_in_exp_response_200_password_policy_rejects = cls(
            pwned=pwned,
        ...
        patch_api_sign_in_exp_response_200_password_policy_rejects.additional_properties = d
        return patch_api_sign_in_exp_response_200_password_policy_rejects
