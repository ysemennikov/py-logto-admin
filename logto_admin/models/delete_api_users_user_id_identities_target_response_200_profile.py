...
if TYPE_CHECKING:
    from ..models.delete_api_users_user_id_identities_target_response_200_profile_address import (
        DeleteApiUsersUserIdIdentitiesTargetResponse200ProfileAddress,
    )


T = TypeVar("T", bound="DeleteApiUsersUserIdIdentitiesTargetResponse200Profile")


@_attrs_define
class DeleteApiUsersUserIdIdentitiesTargetResponse200Profile:
    """
    Attributes:
        ...
        address (Union[Unset, DeleteApiUsersUserIdIdentitiesTargetResponse200ProfileAddress]):
    """
    ...
    address: Union[Unset, "DeleteApiUsersUserIdIdentitiesTargetResponse200ProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = DeleteApiUsersUserIdIdentitiesTargetResponse200ProfileAddress.from_dict(_address)

        delete_api_users_user_id_identities_target_response_200_profile = cls(
        ...
        delete_api_users_user_id_identities_target_response_200_profile.additional_properties = d
        return delete_api_users_user_id_identities_target_response_200_profile
