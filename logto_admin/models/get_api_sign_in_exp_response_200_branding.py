...
T = TypeVar("T", bound="GetApiSignInExpResponse200Branding")


@_attrs_define
class GetApiSignInExpResponse200Branding:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_sign_in_exp_response_200_branding = cls(
            logo_url=logo_url,
            dark_logo_url=dark_logo_url,
            favicon=favicon,
        )

        get_api_sign_in_exp_response_200_branding.additional_properties = d
        return get_api_sign_in_exp_response_200_branding
