...
T = TypeVar("T", bound="PostApiUsersResponse200ProfileAddress")


@_attrs_define
class PostApiUsersResponse200ProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_api_users_response_200_profile_address = cls(
            formatted=formatted,
        ...
        post_api_users_response_200_profile_address.additional_properties = d
        return post_api_users_response_200_profile_address
