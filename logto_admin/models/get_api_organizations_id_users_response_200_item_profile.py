...
if TYPE_CHECKING:
    from ..models.get_api_organizations_id_users_response_200_item_profile_address import (
        GetApiOrganizationsIdUsersResponse200ItemProfileAddress,
    )


T = TypeVar("T", bound="GetApiOrganizationsIdUsersResponse200ItemProfile")


@_attrs_define
class GetApiOrganizationsIdUsersResponse200ItemProfile:
    """
    Attributes:
        ...
        address (Union[Unset, GetApiOrganizationsIdUsersResponse200ItemProfileAddress]):
    """
    ...
    address: Union[Unset, "GetApiOrganizationsIdUsersResponse200ItemProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = GetApiOrganizationsIdUsersResponse200ItemProfileAddress.from_dict(_address)

        get_api_organizations_id_users_response_200_item_profile = cls(
        ...
        get_api_organizations_id_users_response_200_item_profile.additional_properties = d
        return get_api_organizations_id_users_response_200_item_profile
