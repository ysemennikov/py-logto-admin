...
if TYPE_CHECKING:
    from ..models.post_api_users_response_200_custom_data import PostApiUsersResponse200CustomData
    from ..models.post_api_users_response_200_identities import PostApiUsersResponse200Identities
    from ..models.post_api_users_response_200_profile import PostApiUsersResponse200Profile
    from ..models.post_api_users_response_200_sso_identities_item import PostApiUsersResponse200SsoIdentitiesItem


T = TypeVar("T", bound="PostApiUsersResponse200")


@_attrs_define
class PostApiUsersResponse200:
    """
    Attributes:
        id (str):
        ...
        custom_data (PostApiUsersResponse200CustomData): arbitrary
        identities (PostApiUsersResponse200Identities):
        last_sign_in_at (Union[None, float]):
        created_at (float):
        updated_at (float):
        profile (PostApiUsersResponse200Profile):
        application_id (Union[None, str]):
        is_suspended (bool):
        has_password (Union[Unset, bool]):
        sso_identities (Union[Unset, List['PostApiUsersResponse200SsoIdentitiesItem']]):
    """
    ...
    name: Union[None, str]
    avatar: Union[None, str]
    custom_data: "PostApiUsersResponse200CustomData"
    identities: "PostApiUsersResponse200Identities"
    last_sign_in_at: Union[None, float]
    created_at: float
    updated_at: float
    ...
    sso_identities: Union[Unset, List["PostApiUsersResponse200SsoIdentitiesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_data = PostApiUsersResponse200CustomData.from_dict(d.pop("customData"))

        identities = PostApiUsersResponse200Identities.from_dict(d.pop("identities"))
        ...
        profile = PostApiUsersResponse200Profile.from_dict(d.pop("profile"))
        ...
        for sso_identities_item_data in _sso_identities or []:
            sso_identities_item = PostApiUsersResponse200SsoIdentitiesItem.from_dict(sso_identities_item_data)

            sso_identities.append(sso_identities_item)

        post_api_users_response_200 = cls(
            id=id,
            username=username,
        ...
        post_api_users_response_200.additional_properties = d
        return post_api_users_response_200
