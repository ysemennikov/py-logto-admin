...
T = TypeVar("T", bound="GetApiApplicationsResponse200ItemCustomClientMetadata")


@_attrs_define
class GetApiApplicationsResponse200ItemCustomClientMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_applications_response_200_item_custom_client_metadata = cls(
        ...
        get_api_applications_response_200_item_custom_client_metadata.additional_properties = d
        return get_api_applications_response_200_item_custom_client_metadata
