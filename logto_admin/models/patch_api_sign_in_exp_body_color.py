...
T = TypeVar("T", bound="PatchApiSignInExpBodyColor")


@_attrs_define
class PatchApiSignInExpBodyColor:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_sign_in_exp_body_color = cls(
            primary_color=primary_color,
            is_dark_mode_enabled=is_dark_mode_enabled,
            dark_primary_color=dark_primary_color,
        )

        patch_api_sign_in_exp_body_color.additional_properties = d
        return patch_api_sign_in_exp_body_color
