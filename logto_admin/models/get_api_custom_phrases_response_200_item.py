...
T = TypeVar("T", bound="GetApiCustomPhrasesResponse200Item")


@_attrs_define
class GetApiCustomPhrasesResponse200Item:
    """
    Attributes:
        id (str):
        language_tag (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_custom_phrases_response_200_item = cls(
            id=id,
            language_tag=language_tag,
            translation=translation,
        )

        get_api_custom_phrases_response_200_item.additional_properties = d
        return get_api_custom_phrases_response_200_item
