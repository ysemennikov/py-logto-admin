...
T = TypeVar("T", bound="GetApiUsersResponse200ItemProfileAddress")


@_attrs_define
class GetApiUsersResponse200ItemProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_users_response_200_item_profile_address = cls(
            formatted=formatted,
        ...
        get_api_users_response_200_item_profile_address.additional_properties = d
        return get_api_users_response_200_item_profile_address
