...
T = TypeVar("T", bound="PutApiApplicationsApplicationIdSignInExperienceBodyBranding")


@_attrs_define
class PutApiApplicationsApplicationIdSignInExperienceBodyBranding:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_api_applications_application_id_sign_in_experience_body_branding = cls(
            logo_url=logo_url,
            dark_logo_url=dark_logo_url,
            favicon=favicon,
        )

        put_api_applications_application_id_sign_in_experience_body_branding.additional_properties = d
        return put_api_applications_application_id_sign_in_experience_body_branding
