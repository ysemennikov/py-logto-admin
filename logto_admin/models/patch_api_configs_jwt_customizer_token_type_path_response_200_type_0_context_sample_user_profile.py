...
if TYPE_CHECKING:
    from ..models.patch_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile_address import (
        PatchApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress,
    )


T = TypeVar("T", bound="PatchApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile")


@_attrs_define
class PatchApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile:
    """
    Attributes:
    ...
    address: Union[
        Unset, "PatchApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        address: Union[Unset, PatchApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress]
        if isinstance(_address, Unset):
            address = UNSET
        else:
            address = (
                PatchApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress.from_dict(
                    _address
                )
            )

        patch_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile = cls(
        ...
        patch_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile.additional_properties = d
        return patch_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile
