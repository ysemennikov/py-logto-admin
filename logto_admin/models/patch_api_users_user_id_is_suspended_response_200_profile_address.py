...
T = TypeVar("T", bound="PatchApiUsersUserIdIsSuspendedResponse200ProfileAddress")


@_attrs_define
class PatchApiUsersUserIdIsSuspendedResponse200ProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_users_user_id_is_suspended_response_200_profile_address = cls(
            formatted=formatted,
        ...
        patch_api_users_user_id_is_suspended_response_200_profile_address.additional_properties = d
        return patch_api_users_user_id_is_suspended_response_200_profile_address
