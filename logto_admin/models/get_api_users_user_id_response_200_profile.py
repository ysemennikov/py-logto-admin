...
if TYPE_CHECKING:
    from ..models.get_api_users_user_id_response_200_profile_address import GetApiUsersUserIdResponse200ProfileAddress


T = TypeVar("T", bound="GetApiUsersUserIdResponse200Profile")


@_attrs_define
class GetApiUsersUserIdResponse200Profile:
    """
    Attributes:
        ...
        address (Union[Unset, GetApiUsersUserIdResponse200ProfileAddress]):
    """
    ...
    address: Union[Unset, "GetApiUsersUserIdResponse200ProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.get_api_users_user_id_response_200_profile_address import (
        ...
        if isinstance(_address, Unset):
            ...
            address = GetApiUsersUserIdResponse200ProfileAddress.from_dict(_address)

        get_api_users_user_id_response_200_profile = cls(
        ...
        get_api_users_user_id_response_200_profile.additional_properties = d
        return get_api_users_user_id_response_200_profile
