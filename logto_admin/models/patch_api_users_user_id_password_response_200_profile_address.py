...
T = TypeVar("T", bound="PatchApiUsersUserIdPasswordResponse200ProfileAddress")


@_attrs_define
class PatchApiUsersUserIdPasswordResponse200ProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_users_user_id_password_response_200_profile_address = cls(
            formatted=formatted,
        ...
        patch_api_users_user_id_password_response_200_profile_address.additional_properties = d
        return patch_api_users_user_id_password_response_200_profile_address
