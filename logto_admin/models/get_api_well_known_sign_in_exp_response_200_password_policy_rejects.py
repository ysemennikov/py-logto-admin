...
T = TypeVar("T", bound="GetApiWellKnownSignInExpResponse200PasswordPolicyRejects")


@_attrs_define
class GetApiWellKnownSignInExpResponse200PasswordPolicyRejects:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_well_known_sign_in_exp_response_200_password_policy_rejects = cls(
            pwned=pwned,
        ...
        get_api_well_known_sign_in_exp_response_200_password_policy_rejects.additional_properties = d
        return get_api_well_known_sign_in_exp_response_200_password_policy_rejects
