...
if TYPE_CHECKING:
    from ..models.put_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile_address import (
        PutApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress,
    )


T = TypeVar("T", bound="PutApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile")


@_attrs_define
class PutApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile:
    """
    Attributes:
        ...
        address (Union[Unset, PutApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress]):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = PutApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress.from_dict(
                _address
            )

        put_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile = cls(
        ...
        put_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile.additional_properties = d
        return put_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile
