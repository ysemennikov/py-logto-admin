...
T = TypeVar("T", bound="GetApiConfigsAdminConsoleResponse200CheckedChargeNotification")


@_attrs_define
class GetApiConfigsAdminConsoleResponse200CheckedChargeNotification:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_configs_admin_console_response_200_checked_charge_notification = cls(
            token=token,
        ...
        get_api_configs_admin_console_response_200_checked_charge_notification.additional_properties = d
        return get_api_configs_admin_console_response_200_checked_charge_notification
