...
if TYPE_CHECKING:
    from ..models.post_api_users_body_profile_address import PostApiUsersBodyProfileAddress


T = TypeVar("T", bound="PostApiUsersBodyProfile")


@_attrs_define
class PostApiUsersBodyProfile:
    """
    Attributes:
        ...
        address (Union[Unset, PostApiUsersBodyProfileAddress]):
    """
    ...
    address: Union[Unset, "PostApiUsersBodyProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = PostApiUsersBodyProfileAddress.from_dict(_address)

        post_api_users_body_profile = cls(
        ...
        post_api_users_body_profile.additional_properties = d
        return post_api_users_body_profile
