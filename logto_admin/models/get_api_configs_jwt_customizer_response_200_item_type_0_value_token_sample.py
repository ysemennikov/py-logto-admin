...
T = TypeVar("T", bound="GetApiConfigsJwtCustomizerResponse200ItemType0ValueTokenSample")


@_attrs_define
class GetApiConfigsJwtCustomizerResponse200ItemType0ValueTokenSample:
    """
    Attributes:
        jti (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_configs_jwt_customizer_response_200_item_type_0_value_token_sample = cls(
            jti=jti,
            aud=aud,
            scope=scope,
            client_id=client_id,
        ...
        get_api_configs_jwt_customizer_response_200_item_type_0_value_token_sample.additional_properties = d
        return get_api_configs_jwt_customizer_response_200_item_type_0_value_token_sample
