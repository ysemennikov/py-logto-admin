...
T = TypeVar("T", bound="GetApiApplicationsIdResponse200CustomClientMetadata")


@_attrs_define
class GetApiApplicationsIdResponse200CustomClientMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_applications_id_response_200_custom_client_metadata = cls(
        ...
        get_api_applications_id_response_200_custom_client_metadata.additional_properties = d
        return get_api_applications_id_response_200_custom_client_metadata
