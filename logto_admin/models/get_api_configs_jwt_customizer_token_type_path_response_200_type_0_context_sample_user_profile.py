...
if TYPE_CHECKING:
    from ..models.get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile_address import (
        GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress,
    )


T = TypeVar("T", bound="GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile")


@_attrs_define
class GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfile:
    """
    Attributes:
        ...
        address (Union[Unset, GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress]):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0ContextSampleUserProfileAddress.from_dict(
                _address
            )

        get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile = cls(
        ...
        get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile.additional_properties = d
        return get_api_configs_jwt_customizer_token_type_path_response_200_type_0_context_sample_user_profile
