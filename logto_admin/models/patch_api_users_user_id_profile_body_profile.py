...
if TYPE_CHECKING:
    from ..models.patch_api_users_user_id_profile_body_profile_address import (
        PatchApiUsersUserIdProfileBodyProfileAddress,
    )


T = TypeVar("T", bound="PatchApiUsersUserIdProfileBodyProfile")


@_attrs_define
class PatchApiUsersUserIdProfileBodyProfile:
    ...
    Attributes:
        ...
        address (Union[Unset, PatchApiUsersUserIdProfileBodyProfileAddress]):
    """
    ...
    address: Union[Unset, "PatchApiUsersUserIdProfileBodyProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = PatchApiUsersUserIdProfileBodyProfileAddress.from_dict(_address)

        patch_api_users_user_id_profile_body_profile = cls(
        ...
        patch_api_users_user_id_profile_body_profile.additional_properties = d
        return patch_api_users_user_id_profile_body_profile
