...
if TYPE_CHECKING:
    from ..models.patch_api_users_user_id_response_200_profile_address import (
        PatchApiUsersUserIdResponse200ProfileAddress,
    )


T = TypeVar("T", bound="PatchApiUsersUserIdResponse200Profile")


@_attrs_define
class PatchApiUsersUserIdResponse200Profile:
    """
    Attributes:
        ...
        address (Union[Unset, PatchApiUsersUserIdResponse200ProfileAddress]):
    """
    ...
    address: Union[Unset, "PatchApiUsersUserIdResponse200ProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = PatchApiUsersUserIdResponse200ProfileAddress.from_dict(_address)

        patch_api_users_user_id_response_200_profile = cls(
        ...
        patch_api_users_user_id_response_200_profile.additional_properties = d
        return patch_api_users_user_id_response_200_profile
