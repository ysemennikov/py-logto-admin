...
T = TypeVar("T", bound="PutApiOrganizationsIdUsersUserIdRolesBody")


@_attrs_define
class PutApiOrganizationsIdUsersUserIdRolesBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_api_organizations_id_users_user_id_roles_body = cls(
            organization_role_ids=organization_role_ids,
        )

        put_api_organizations_id_users_user_id_roles_body.additional_properties = d
        return put_api_organizations_id_users_user_id_roles_body
