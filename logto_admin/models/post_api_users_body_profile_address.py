...
T = TypeVar("T", bound="PostApiUsersBodyProfileAddress")


@_attrs_define
class PostApiUsersBodyProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_api_users_body_profile_address = cls(
            formatted=formatted,
        ...
        post_api_users_body_profile_address.additional_properties = d
        return post_api_users_body_profile_address
