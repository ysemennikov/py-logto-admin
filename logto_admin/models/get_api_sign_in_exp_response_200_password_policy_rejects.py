...
T = TypeVar("T", bound="GetApiSignInExpResponse200PasswordPolicyRejects")


@_attrs_define
class GetApiSignInExpResponse200PasswordPolicyRejects:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_sign_in_exp_response_200_password_policy_rejects = cls(
            pwned=pwned,
        ...
        get_api_sign_in_exp_response_200_password_policy_rejects.additional_properties = d
        return get_api_sign_in_exp_response_200_password_policy_rejects
