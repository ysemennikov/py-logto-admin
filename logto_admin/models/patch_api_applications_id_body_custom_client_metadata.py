...
T = TypeVar("T", bound="PatchApiApplicationsIdBodyCustomClientMetadata")


@_attrs_define
class PatchApiApplicationsIdBodyCustomClientMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_applications_id_body_custom_client_metadata = cls(
        ...
        patch_api_applications_id_body_custom_client_metadata.additional_properties = d
        return patch_api_applications_id_body_custom_client_metadata
