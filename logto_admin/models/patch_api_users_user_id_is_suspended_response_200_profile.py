...
if TYPE_CHECKING:
    from ..models.patch_api_users_user_id_is_suspended_response_200_profile_address import (
        PatchApiUsersUserIdIsSuspendedResponse200ProfileAddress,
    )


T = TypeVar("T", bound="PatchApiUsersUserIdIsSuspendedResponse200Profile")


@_attrs_define
class PatchApiUsersUserIdIsSuspendedResponse200Profile:
    """
    Attributes:
        ...
        address (Union[Unset, PatchApiUsersUserIdIsSuspendedResponse200ProfileAddress]):
    """
    ...
    address: Union[Unset, "PatchApiUsersUserIdIsSuspendedResponse200ProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = PatchApiUsersUserIdIsSuspendedResponse200ProfileAddress.from_dict(_address)

        patch_api_users_user_id_is_suspended_response_200_profile = cls(
        ...
        patch_api_users_user_id_is_suspended_response_200_profile.additional_properties = d
        return patch_api_users_user_id_is_suspended_response_200_profile
