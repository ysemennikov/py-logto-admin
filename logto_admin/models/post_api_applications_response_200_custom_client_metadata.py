...
T = TypeVar("T", bound="PostApiApplicationsResponse200CustomClientMetadata")


@_attrs_define
class PostApiApplicationsResponse200CustomClientMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_api_applications_response_200_custom_client_metadata = cls(
        ...
        post_api_applications_response_200_custom_client_metadata.additional_properties = d
        return post_api_applications_response_200_custom_client_metadata
