...
T = TypeVar("T", bound="GetApiWellKnownSignInExpResponse200Color")


@_attrs_define
class GetApiWellKnownSignInExpResponse200Color:
    """
    Attributes:
        primary_color (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_well_known_sign_in_exp_response_200_color = cls(
            primary_color=primary_color,
            is_dark_mode_enabled=is_dark_mode_enabled,
            dark_primary_color=dark_primary_color,
        )

        get_api_well_known_sign_in_exp_response_200_color.additional_properties = d
        return get_api_well_known_sign_in_exp_response_200_color
