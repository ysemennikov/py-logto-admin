...
if TYPE_CHECKING:
    from ..models.get_api_connectors_id_response_200_form_items_item_type_0_select_items_item import (
        GetApiConnectorsIdResponse200FormItemsItemType0SelectItemsItem,
    )
    from ..models.get_api_connectors_id_response_200_form_items_item_type_0_show_conditions_item import (
        GetApiConnectorsIdResponse200FormItemsItemType0ShowConditionsItem,
    )


T = TypeVar("T", bound="GetApiConnectorsIdResponse200FormItemsItemType0")


@_attrs_define
class GetApiConnectorsIdResponse200FormItemsItemType0:
    """
    Attributes:
        type (str):
        select_items (List['GetApiConnectorsIdResponse200FormItemsItemType0SelectItemsItem']):
        key (str):
        label (str):
        placeholder (Union[Unset, str]):
        required (Union[Unset, bool]):
        default_value (Union[Unset, Any]):
        show_conditions (Union[Unset, List['GetApiConnectorsIdResponse200FormItemsItemType0ShowConditionsItem']]):
    ...
    show_conditions: Union[Unset, List["GetApiConnectorsIdResponse200FormItemsItemType0ShowConditionsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for select_items_item_data in _select_items:
            select_items_item = GetApiConnectorsIdResponse200FormItemsItemType0SelectItemsItem.from_dict(
        ...
        for show_conditions_item_data in _show_conditions or []:
            show_conditions_item = GetApiConnectorsIdResponse200FormItemsItemType0ShowConditionsItem.from_dict(
        ...
        get_api_connectors_id_response_200_form_items_item_type_0 = cls(
            type=type,
        ...
        get_api_connectors_id_response_200_form_items_item_type_0.additional_properties = d
        return get_api_connectors_id_response_200_form_items_item_type_0
