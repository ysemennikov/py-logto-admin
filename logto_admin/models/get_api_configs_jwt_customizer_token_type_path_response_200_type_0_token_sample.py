...
T = TypeVar("T", bound="GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0TokenSample")


@_attrs_define
class GetApiConfigsJwtCustomizerTokenTypePathResponse200Type0TokenSample:
    """
    Attributes:
        jti (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_configs_jwt_customizer_token_type_path_response_200_type_0_token_sample = cls(
            jti=jti,
            aud=aud,
            scope=scope,
            client_id=client_id,
        ...
        get_api_configs_jwt_customizer_token_type_path_response_200_type_0_token_sample.additional_properties = d
        return get_api_configs_jwt_customizer_token_type_path_response_200_type_0_token_sample
