...
T = TypeVar("T", bound="GetApiUsersUserIdResponse200ProfileAddress")


@_attrs_define
class GetApiUsersUserIdResponse200ProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_api_users_user_id_response_200_profile_address = cls(
            formatted=formatted,
        ...
        get_api_users_user_id_response_200_profile_address.additional_properties = d
        return get_api_users_user_id_response_200_profile_address
