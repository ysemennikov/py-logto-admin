...
T = TypeVar("T", bound="PatchApiUsersUserIdProfileBodyProfileAddress")


@_attrs_define
class PatchApiUsersUserIdProfileBodyProfileAddress:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_users_user_id_profile_body_profile_address = cls(
            formatted=formatted,
        ...
        patch_api_users_user_id_profile_body_profile_address.additional_properties = d
        return patch_api_users_user_id_profile_body_profile_address
