...
if TYPE_CHECKING:
    from ..models.patch_api_users_user_id_body_profile_address import PatchApiUsersUserIdBodyProfileAddress


T = TypeVar("T", bound="PatchApiUsersUserIdBodyProfile")


@_attrs_define
class PatchApiUsersUserIdBodyProfile:
    """
    Attributes:
        ...
        address (Union[Unset, PatchApiUsersUserIdBodyProfileAddress]):
    """
    ...
    address: Union[Unset, "PatchApiUsersUserIdBodyProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = PatchApiUsersUserIdBodyProfileAddress.from_dict(_address)

        patch_api_users_user_id_body_profile = cls(
        ...
        patch_api_users_user_id_body_profile.additional_properties = d
        return patch_api_users_user_id_body_profile
