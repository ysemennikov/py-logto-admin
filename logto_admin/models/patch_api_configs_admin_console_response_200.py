...
if TYPE_CHECKING:
    from ..models.patch_api_configs_admin_console_response_200_checked_charge_notification import (
        PatchApiConfigsAdminConsoleResponse200CheckedChargeNotification,
    )
    from ..models.patch_api_configs_admin_console_response_200_development_tenant_migration_notification import (
        PatchApiConfigsAdminConsoleResponse200DevelopmentTenantMigrationNotification,
    )


T = TypeVar("T", bound="PatchApiConfigsAdminConsoleResponse200")


@_attrs_define
class PatchApiConfigsAdminConsoleResponse200:
    """
    Attributes:
        ...
        development_tenant_migration_notification (Union[Unset,
            PatchApiConfigsAdminConsoleResponse200DevelopmentTenantMigrationNotification]):
        checked_charge_notification (Union[Unset, PatchApiConfigsAdminConsoleResponse200CheckedChargeNotification]):
    """

    sign_in_experience_customized: bool
    organization_created: bool
    development_tenant_migration_notification: Union[
        Unset, "PatchApiConfigsAdminConsoleResponse200DevelopmentTenantMigrationNotification"
    ] = UNSET
    checked_charge_notification: Union[Unset, "PatchApiConfigsAdminConsoleResponse200CheckedChargeNotification"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_development_tenant_migration_notification, Unset):
            ...
            development_tenant_migration_notification = (
                PatchApiConfigsAdminConsoleResponse200DevelopmentTenantMigrationNotification.from_dict(
        ...
        if isinstance(_checked_charge_notification, Unset):
            ...
            checked_charge_notification = PatchApiConfigsAdminConsoleResponse200CheckedChargeNotification.from_dict(
                _checked_charge_notification
            )

        patch_api_configs_admin_console_response_200 = cls(
        ...
        patch_api_configs_admin_console_response_200.additional_properties = d
        return patch_api_configs_admin_console_response_200
