...
if TYPE_CHECKING:
    from ..models.post_api_users_response_200_profile_address import PostApiUsersResponse200ProfileAddress


T = TypeVar("T", bound="PostApiUsersResponse200Profile")


@_attrs_define
class PostApiUsersResponse200Profile:
    """
    Attributes:
        ...
        address (Union[Unset, PostApiUsersResponse200ProfileAddress]):
    """
    ...
    address: Union[Unset, "PostApiUsersResponse200ProfileAddress"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_address, Unset):
            ...
            address = PostApiUsersResponse200ProfileAddress.from_dict(_address)

        post_api_users_response_200_profile = cls(
        ...
        post_api_users_response_200_profile.additional_properties = d
        return post_api_users_response_200_profile
