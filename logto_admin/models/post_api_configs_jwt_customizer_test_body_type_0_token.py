...
T = TypeVar("T", bound="PostApiConfigsJwtCustomizerTestBodyType0Token")


@_attrs_define
class PostApiConfigsJwtCustomizerTestBodyType0Token:
    """
    Attributes:
        jti (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_api_configs_jwt_customizer_test_body_type_0_token = cls(
            jti=jti,
            aud=aud,
            scope=scope,
            client_id=client_id,
        ...
        post_api_configs_jwt_customizer_test_body_type_0_token.additional_properties = d
        return post_api_configs_jwt_customizer_test_body_type_0_token
