...
T = TypeVar("T", bound="PatchApiUsersUserIdProfileResponse200Address")


@_attrs_define
class PatchApiUsersUserIdProfileResponse200Address:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_api_users_user_id_profile_response_200_address = cls(
            formatted=formatted,
        ...
        patch_api_users_user_id_profile_response_200_address.additional_properties = d
        return patch_api_users_user_id_profile_response_200_address
